...
INSERT INTO Utilisateur (email, mdp, typeUtilisateur, nivEtude, nom, prenom, ecole, ville) VALUES
    ...
    ('user7@example.com', '$2y$10$XplaSBMvya1D3rSmg1wu7OjTkPt0Sdn2gcwqtfm7mvcB/LFOhvxay', 'normal', 'L1', 'Anderson', 'Sophie', 'University G', 'City G'),
    ('user8@example.com', '$2y$10$zJ8X4DKX3tl88oo2RGCtyeBLREz70eD0YyYCxPhc15BmqXBcy8jbC', 'normal', 'L2', 'McArthur', 'Emma', 'University H', 'City H'),
    ('user9@example.com', '$2y$10$cAcn0VDR35KZqvJPlhYVq.M93cEBxaG0Z0oWfnRGfFmHMWb3epJdK', 'gestionnaire', 'L3', 'Taylor', 'Noah', 'University I', 'City I'),
    ('user10@example.com', '$2y$10$xOnZPQPavEpIGGzU6QeKzufqk/kiifFydfINtOwZrhnPTy8rTBe6.', 'normal', 'M1', 'Clark', 'Ava', 'University J', 'City J'),
    ('user11@example.com', '$2y$10$8DUY1oH13s4v/Q7Fxg6ZX.83Rq8JBy9Cx6V0EGN0AZJ4.hEfY7uVq', 'normal', 'M2', 'Moore', 'Liam', 'University K', 'City K'),
    ('user12@example.com', '$2y$10$YXNcPHLias0IR9DKsjrboeAs7wniH6B9SpgsWPSkcAubNp/VE.Mby', 'normal', 'L1', 'Lee', 'Mia', 'University L', 'City L'),
    ('user13@example.com', '$2y$10$O0oQiWjkamFTy.FONhuXouXEDoD16VH/a64XrmUtOB8OzSgc0HxEK', 'normal', 'L2', 'Lewis', 'Benjamin', 'University M', 'City M'),
    ('user14@example.com', '$2y$10$D9iGt7L8kGcLpwjmi2Ldtu1IV2OkZLHvypSD72qEYdvl8uTmx0KjC', 'normal', 'L3', 'Baker', 'Ella', 'University N', 'City N'),
    ('user15@example.com', '$2y$10$6R9Lacl8eHoLbFxjiPY9auPZb7ulHLyMHXe6boVWGqcniny9djwpK', 'gestionnaire', 'M1', 'Garcia', 'Jacob', 'University O', 'City O'),
    ('user16@example.com', '$2y$10$ymHtCRGaCj6cBau5CKMf8OOFMHI9FEzvyJ8w3bK0uD9ic6BY4xQ1O', 'gestionnaire', 'M2', 'Gonzalez', 'Sophia', 'University P', 'City P'),
    ('user17@example.com', '$2y$10$HgUXulrco/WtkUIDBoWO5OFrQGeLXFHjgs4J6s8yLWUKlDvES630S', 'normal', 'L1', 'Perez', 'Emily', 'University Q', 'City Q'),
    ('user18@example.com', '$2y$10$trjpPbOHJV3TWnJOnho0Wu9oJUq1ptJSSWXk29SZam/xi1tJUqQ4W', 'normal', 'L2', 'Rodriguez', 'Daniel', 'University R', 'City R'),
    ('user19@example.com', '$2y$10$.lAAU2LDC9py5XmcAlxM/eBM3hvFCEcqCLCwfEoe1S7ScITKOJ59W', 'normal', 'L3', 'Smith', 'Michael', 'University S', 'City S'),
    ('user20@example.com', '$2y$10$H.PZJqCiEyWz79AVJw7qeuEFffClclxWideuMNuU9w1Jseuz3hJGS', 'normal', 'M1', 'Johnson', 'Olivia', 'University T', 'City T'),
    ('user21@example.com', '$2y$10$xEoRk9h/2mcrjquWrDByG.EDctGZaRqLnXGf8KNizjIdKpiBp4SGC', 'normal', 'M2', 'Williams', 'William', 'University U', 'City U'),
    ('user22@example.com', '$2y$10$Y2PITSl/xInJurZESckngOjuA.d.ScoDFFoUil.FNylE.DM1EdYwm', 'gestionnaire', 'L1', 'Brown', 'Ava', 'University V', 'City V'),
    ('user23@example.com', '$2y$10$xE6hylecpcbzS/SUw5erAenXj4xVmK/nJXCJ/AfrPqLAyuWUIGIzi', 'normal', 'M1', 'Johnson', 'Olivia', 'University X', 'City X'),
    ('user24@example.com', '$2y$10$Wze7HpDCdoUuY9I7Ob14ceoohulkB4RSmZzAH5Iusbcpwbxql04s6', 'normal', 'L2', 'Smith', 'James', 'University Y', 'City Y'),
    ('user25@example.com', '$2y$10$yu2b.XTIOdMd7gLln3zR.uqsYnCT2.dcJ6z2/xrNXxqA9XXmUg5GK', 'normal', 'M2', 'Taylor', 'Sophia', 'University Z', 'City Z'),
    ('user26@example.com', '$2y$10$JRkzrcSJebiWM4s8/CpIreIVb9N5gqx1T5oxhrxK/XlYA2IR6cjUK', 'normal', 'L1', 'Anderson', 'Oliver', 'University W', 'City W'),
    ('user27@example.com', '$2y$10$WyFaPh6.STIDfKdxbP0qHeOwR7eq.3HV2eFLbiq.DgWviWkZ3U5Ie', 'normal', 'M1', 'Martinez', 'Emma', 'University U', 'City U'),
    ('user28@example.com', '$2y$10$xv/ZCodIkV7xL/7QBVWwOu2pBxPId68CgnHFD4h/DVKRlEYfYIU4e', 'normal', 'L2', 'Harris', 'Liam', 'University V', 'City V'),
    ('user29@example.com', '$2y$10$sgWTrqjvd8w0ZuT.65xZfuzVKx4SLm24h2hr0m1A332Cx8eQnSMD2', 'normal', 'M2', 'Walker', 'Mia', 'University X', 'City X'),
    ('user30@example.com', '$2y$10$CprP9vi8fIINW6IQhOh8Uus7lccTDgUbXiI96VyR7J4VK3Tas7Knm', 'normal', 'L1', 'Clark', 'Ava', 'University Y', 'City Y'),
    ('user31@example.com', '$2y$10$jIl8ve9zjIrD3jdXjlg9LuuBVFkyHBHJbQ/PHD6DAsCcXogjiTUDm', 'normal', 'M1', 'Garcia', 'Noah', 'University Z', 'City Z'),
    ('user32@example.com', '$2y$10$AgR4P6oAj6ypeftowAskq.c0ADCL0hWnDLWuAURQHhH2WScqbK4r2', 'normal', 'L2', 'Lewis', 'Isabella', 'University W', 'City W'),
    ('user33@example.com', '$2y$10$bIdEB.e4jyVTmwoJOTLgcODGVU5Db.rMyR1Zm9QjZAcI//k9coE.a', 'normal', 'M2', 'Rodriguez', 'Sophia', 'University U', 'City U'),
    ('user34@example.com', '$2y$10$4tcToTbrdP97qefvYzn1KeY0rBVmwLli78FuO18ixRVg4iaTJ1MOy', 'normal', 'L1', 'Adams', 'Elijah', 'University V', 'City V'),
    ('user35@example.com', '$2y$10$OKc1TcnuePFnVJipp566euH68sPqqu0Cgnqi5nWO92hDr1Ki7u1vC', 'normal', 'M1', 'Lee', 'Olivia', 'University X', 'City X'),
    ('user36@example.com', '$2y$10$MioSOVTVU4Gqzg9vsXVaI.3mOqaYNn.IrTS6PkX1BPUzh2UHXdCIK', 'normal', 'L2', 'Baker', 'Mason', 'University Y', 'City Y'),
    ('user37@example.com', '$2y$10$GBwXGDy0G1gJmz684dcwc.NJu6WKSxLcGMp0BstReE/aJlcFQvN72', 'normal', 'M2', 'Wright', 'Ava', 'University Z', 'City Z');
