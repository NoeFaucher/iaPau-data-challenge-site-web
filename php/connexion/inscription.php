...
<body>
    ...
    <main style="height:fit-content;">
        ...
        <h1 id="connexTitle">Inscrivez-vous !</h1>
            ...
            <div class="champ">
                <label for="niveau-etude">Niveau d'étude :</label><br>
            ...
            <div class="champ">
                <label for="ecole" id="ecole">École :</label><br><input type="text" name="ecole_participant">
            </div>
            <div class="champ">
                <label for="ville" id="ville">Ville :</label><br><input type="text" name="ville_participant">
            </div>
